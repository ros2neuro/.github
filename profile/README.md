...
- 2026-05-05 [ltonin] **ros2neuro_decoder**, **ros2neuro_decoder_svm**, **ros2neuro_decoder_qda**, **ros2neuro_decoder_gaussian**, **ros2neuro_integrator**, **ros2neuro_integrator_exponential**: Updated `NeuroPrediction` producers and consumers for the new generic message contract.
